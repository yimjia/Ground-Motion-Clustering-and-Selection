...
Encode = readmatrix(sprintf('Data_NonPulse_Finetune/Encode'));
Loss = readmatrix(sprintf('Data_NonPulse_Finetune/Loss'));
Loss_Epoch = readmatrix(sprintf('Data_NonPulse_Finetune/Min_Loss_Epoch'));    
DecodeSa_Raw = readmatrix(sprintf('Data_NonPulse_Finetune/Decode_Sa'));
